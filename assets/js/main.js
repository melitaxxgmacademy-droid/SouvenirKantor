...
(function() {
  ...
  function normalizeLayananLinks() {
    document.querySelectorAll('.nav-column').forEach(function(col) {
      try {
        ...
        p.className = 'footer-layanan-text';
        p.textContent = 'Pilihan layanan: Souvenir kantor, Souvenir custom, Merchandise, Seminar Kit. Untuk konsultasi, gunakan tombol Chat WhatsApp.';
        col.appendChild(p);
    ...
    try {
      ...
      if (navUl && !navUl.querySelector('a[href="blog.html"]')) {
        ...
        if (layananLi && layananLi.parentNode) {
          layananLi.parentNode.insertBefore(li, layananLi.nextSibling);
        } else {
  ...
  function enhanceWhatsAppFloat() {
    ...
    widget.innerHTML = [
      ...
      '      <img src="images/Logo.webp" alt="SouvenirPro">',
      ...
      '  <span class="wa-widget-trigger-logo"><img src="images/Logo.webp" alt=""></span>',
